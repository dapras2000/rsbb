...
<form name="formsavelab" id="formsavelab" method="post" action="vk/lab/saveorderlab.php">
...
?>
 ...
 <br />
 <table>
 <tr><td><input type="submit" class="text" value="S i m p a n" submit="submitform (document.getElementById('formsavelab'),'vk/lab/saveorderlab.php','validlab',validatetask);return false;" />
 </td></tr>
 </table>

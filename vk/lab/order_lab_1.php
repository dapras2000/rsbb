...
?>
  ...
  <p>
    ...
    <form name="formlab" id="formlab" method="post" action="vk/lab/validorderlab.php">
       <table width="100%"><tr>
...
<?php  if(count($row2_tab_1 > 0)){
            ...
            <tr>
             ...
             onchange="newsubmitform (document.getElementById('formlab'),'vk/lab/validorderlab.php','validlab',validatetask); return false;"/>&nbsp;<?php echo $data2_tab_1['nama_jasa']?></td>
            </tr>
<? } }?>
<?php } ?>     
   </table></td>
...
<?php  if(count($row2_tab_2 > 0)){
            ...
            <tr>
             ...
             onchange="newsubmitform (document.getElementById('formlab'),'vk/lab/validorderlab.php','validlab',validatetask); return false;"/>&nbsp;<?php echo $data2_tab_2['nama_jasa']?></td>
            </tr>
<? } }?>
<?php } ?>     
   </table>
...
<?php  if(count($row2_tab_3 > 0)){
            ...
            <tr>
             ...
             onchange="newsubmitform (document.getElementById('formlab'),'vk/lab/validorderlab.php','validlab',validatetask); return false;"/>&nbsp;<?php echo $data2_tab_3['nama_jasa']?></td>
            </tr>
<? } }?>
<?php } ?>     
   </table>
...
<?php  if(count($row2_tab_4 > 0)){
            ...
            <tr>
             ...
             onchange="newsubmitform (document.getElementById('formlab'),'vk/lab/validorderlab.php','validlab',validatetask); return false;"/>&nbsp;<?php echo $data2_tab_4['nama_jasa']?></td>
            </tr>
<? } }?>
<?php } ?>     
   </table>

<?
$sql_s_resep = "SELECT t_resep.NORESEP, t_resep_detail.NAMA_OBAT, t_resep_detail.SEDIAAN, t_resep_detail.ATURAN_PAKAI, t_resep_detail.JUMLAH FROM t_resep INNER JOIN t_resep_detail ON (t_resep.NORESEP = t_resep_detail.NORESEP) WHERE t_resep.IDXDAFTAR = ".$idxdaftar;
...
<form name="addbarang" id="addbarang" method="post" action="vk/resep/addobatresep.php" >
<table>
 <tr>
  <td width="92">&nbsp;</td>
  <td width="342">&nbsp;</td>
  ...
  <tr>
  <td>Nama Obat</td>
  <td><input type="text" class="text" name="nm_barang"  id="nm_barang" style="width:300px" onkeypress="autocomplete_resep(this.value, event)"  onblur="document.getElementById('autocompletediv'); Efect.appear('autocompletediv'); " /></td>
  </tr>
<tr>
  <td>Sediaan</td>
...
<tr>
 ...
 <td><select name="aturan" >
  ...
  <tr>
    <td colspan="2" ><input type="submit" class="text" value="A d d" onclick="newsubmitform (document.getElementById('addbarang'),'vk/resep/addobatresep.php','validbarang',validatetask); document.getElementById('nm_barang').value = '';   document.getElementById('jml_permintaan').value = '';   
return false;" /></td> 
  </tr>
 </table>

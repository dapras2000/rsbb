<? 
$diag_sql = "SELECT a.IDXTERAPI, a.DIAGNOSA, a.TERAPI, a.ICD_CODE, a.KASUS_BL, a.ICDCM, b.jenis_penyakit, c.keterangan, a.KUNJUNGAN_BL
...
<form method="post" action="vk/valid_dignosa.php" name="diagnosa" id="diagnosa">

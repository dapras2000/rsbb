...
<table border="0" cellpadding="0" cellspacing="0" width="400px">
	...
	-->
	<tr><td>
			<table style="font-size: 14px; padding-left: 10px;" width="100%">
				...
				<tr  style="font-size: 14px;"><td>Ruang
				</td><td>:</td><td style="font-size: 14px;"><? echo $info.' / '. $info2;?></td></tr>
				<tr><td>
				</td><td></td><td><img  alt="<? echo $data['NOMR']; ?>" src="include/barcode.php?codetype=Code39&size=20&text=<? echo $data['NOMR']; ?>&print=true" /></td></tr>

...
<tr><td>No MR</td><td>: <?php echo $NOMR;?></td><td rowspan="8" align="left" valign="top">DIAGNOSA DAN TERAPI : <br /><? echo $DIAGNOSA; ?><br /><? echo $TERAPI; ?></td></tr>
...
<?php 
$sqls = mysql_query('select * from m_obat where kode_obat like "R%" order by kode_obat'); 
while($rows = mysql_fetch_array($sqls)){
	echo '<option value="'.$rows['kode_obat'].'">'.$rows['nama_obat'].'</option>';
}
?>
</select>

...
$sql="SELECT dokter, b.NAMADOKTER,COUNT(DISTINCT noresep) AS jumlah_resep, 
COUNT(a.qty) AS jumlah_obat, SUM( IF (a.laplain = 'Generik' ,1,0) ) AS generik, 
...
<div align="center">
    <div id="frame" style="width:100%">
        ...
        <div id="frame_title"><h3>
                <? if($bulan!=$bulan2) { ?>
                LAPORAN PEMANTAUAN PENULISAN RESEP OBAT GENERIK RAWAT JALAN Periode <?=$bulan_name?> sd. <?=$bulan_name2?> Tahun <?=$tahun?>
                <? }else { ?>
                LAPORAN PEMANAUAN PENULISAN RESEP OBAT GENERIK RAWAT JALAN Periode <?=$bulan_name?> Tahun <?=$tahun?>
                <? } ?>
            </h3></div>
        <div align="right" style="margin:5px;">
            <div id="table_search">
                <form name="filterlap" id="filterlap" method="get" >
                    <input type="hidden" name="link" value="110x" />
                ...
                <table width="99%" border="0" cellspacing="1" cellpadding="1" class="tb">
                    ...
                    <?
                    $NO=0;
                    #$pager = new PS_Pagination($connect, $sql,1, 5, "bulan=".$bulan."&bulan2=".$bulan2."&tahun=".$tahun,"index.phpx?link=110x&");
					$pager = new PS_Pagination($connect, $sql, 25, 5, "bulan=".$bulan."&bulan2=".$bulan2."&tahun=".$tahun,"index.php?link=110x&");

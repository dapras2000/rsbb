...
<div align="center">
    <div id="frame" style="width: 100%;">
        <div id="frame_title"><h3>LIST OBAT PASIEN RAJAL</h3></div>
    ...
    echo $nama;
                    ...
                    <tr>
                        ...
                        <td><input type="submit" value="Cari" class="text"/>
                            <input type="hidden" name="link" value="list_pasien_apotek_rajal" /></td>
                    </tr>
                </table>
            ...
            <div id="table_search">
				...
				<tr align="center"><th style="width:20px;">No</th><th style="width:80px;">TGL Daftar</th><th style="width:80px;">No RM</th><th>Nama Pasien</th><th style="width:100px;">Poli/ Ruang</th><th>Dokter</th><th width="70px">Cara Bayar</th><th width="100px">&nbsp;</th></tr>
                    <?
                    $NO=0;
...
JOIN m_carabayar e ON e.KODE = a.KDCARABAYAR
                    ...
                    <?php
                        ...
                        <td>
						<?php
							echo '<a href="'._BASE_.'index.php?link=add_resep&nomr='.$data['NOMR'].'&idx='.$data['IDXDAFTAR'].'&rajal=1"><input type="button" value="PROSESS" class="text"/></a>';
						?>
                        </td>
                    </tr>
                        <?	$i++;

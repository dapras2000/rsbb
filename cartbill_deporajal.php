...
jQuery(document).ready(function(){
	...
	jQuery('.print').click(function(){
		var idxdaftar	= jQuery(this).attr('rel');
		var idxbayar	= jQuery(this).attr('svn');
		jQuery.get('<?php echo _BASE_; ?>print_pembayaran_depo.php?idxb='+idxbayar+'&nomr=<?php echo $_REQUEST['nomr']; ?>',function(data){
...
<div align="center">
<div id="frame">
	<div id="frame_title"><h3>Cart Bayar Farmasi Rawat Jalan</h3></div>
...
WHERE a.NOMR = "'.$_REQUEST['nomr'].'" AND b.KODETARIF like "07%" AND a.STATUS !="BATAL" AND b.IDXDAFTAR = "'.$_REQUEST['idxdaftar'].'"
GROUP BY 
a.NOMR, b.NOBILL,
a.TGLBAYAR , b.IDXDAFTAR';

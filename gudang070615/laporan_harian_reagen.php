...
<table border="0" cellspacing="1" cellpadding="1" bordercolor="#999999" class="tb" width="99%">
  <tr>
    ...
    <th colspan="5"><div align="center">PENGELUARAN</div></th>
  ...
  <tr>
    ...
    <th><div align="center">RANAP</div></th>
   </tr>
<?
				
	$pager = new PS_Pagination($connect, $sql, 15, 5, "bulan=".$bulan."&tahun=".$tahun."&group=".$group."&nm_barang=".$nm_barang, "index.php?link=g01&");

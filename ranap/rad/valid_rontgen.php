...
$maxnobyr = $get_data['nomor'];	
  ...
  IDXDAFTAR, NOMR, NIPKIRIM, RAJAL) VALUES(curdate(),'$kd_rad','$_POST[dd_klinik]','$_POST[txtKdDokter]','$_POST[txtKdPoly]','$_POST[txtIdxDaftar]','$_POST[txtNoMR]','$_POST[txtNip]','0')")or die(mysql_error());
        
		
		mysql_query("INSERT INTO t_billranap (KODETARIF, NOMR, KDPOLY, TANGGAL, NIP, QTY, IDXDAFTAR, NOBILL,
  									TARIFRS, KETERANGAN)
					 VALUES ('$kode_tarif', '$_POST[txtNoMR]', '$_POST[txtKdPoly]', curdate(), '$_POST[txtNip]', 1, '$_POST[txtIdxDaftar]', '$maxnobyr', '$tarifrs', '')");
...
if($x == 1){		
echo $psn="<p<strong>Input Data Berhasil</strong></p>";
...
echo $psn="<p><strong>Anda Belum Mengisi Dengan Item Radiologi Field.</strong></p>";
 }
}
?>
...
<form name="formsavelabx" id="formsavelabx" method="post" action="ranap/lab/saveorderlab.php">
...
?>
 ...
 <table>
 <tr><td>Dokter</td>
  <td><select name="txtKdDokter" class="text">
<?
...
<? } ?>
 ...
 <tr><td>
 <div id="validlab">
 <input type="submit" class="text" value="S i m p a n" onclick="newsubmitform (document.getElementById('formsavelabx'),'ranap/lab/saveorderlab.php','formsavelabxxx',validatetask); return false;" />
 </div>
 </td></tr>
 </table>

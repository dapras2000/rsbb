...
$maxnobyr = $get_data['nomor'];	
	...
	while($dat_rad = mysql_fetch_array($get_rad)){
	  ...
	  if(isset($_POST['rad'.$dat_rad['kd_rad']])){
		  ...
		  mysql_query("INSERT INTO t_radiologi VALUES('','$_POST[txtTglReg]','$kd_rad','$_POST[dd_klinik]','$_POST[txtKdDokter]','$_POST[txtKdPoly]','$_POST[txtIdxDaftar]','$_POST[txtNoMR]','','','','','$_POST[txtNip]','','','','','')")or die(mysql_error());
...
header("Location:../index.php?pesan=$psn&menu=3&link=51&nomr=".$_POST['txtNoMR']."&idx=".$_POST['txtIdxDaftar']);
exit;
?>
...
if(mysql_num_rows($s) > 0){
	mysql_query("UPDATE t_diagnosadanterapi set TANGGAL = '".$_POST['txtTglReg']."',
											  ...
											  KLB	= '".$klb."',
											  JENIS = '".$jenis."'
											  where IDXDAFTAR = '".$_REQUEST['txtIdxDaftar']."'");
}else{
	mysql_query("INSERT INTO t_diagnosadanterapi (IDXDAFTAR, NOMR, TANGGAL,DIAGNOSA, TERAPI, KDPOLY, KDDOKTER, NIP, KUNJUNGAN_BL, KASUS_BL,KLB,JENIS)
												  VALUES('".$_POST['txtIdxDaftar']."','".$_POST['txtNoMR']."','".$_POST['txtTglReg']."','".$_POST['elm1']."','".$_REQUEST['elm2']."','".$_POST['txtKdPoly']."','".$_POST['txtKdDokter']."','".$_SESSION['NIP']."','".$kunjungan."', '".$new_kasus."', '".$klb."','".$jenis."')");
}
?>	

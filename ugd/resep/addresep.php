...
jQuery(document).ready(function(){
	jQuery("#nm_barang").autocomplete('<?php echo _BASE_ ;?>autocomplete/nama_obat.php',{
		width: 300,
		multiple: false,
		matchContains: true,
	});
...
<?
$sql_s_resep = "SELECT t_resep.NORESEP, t_resep_detail.NAMA_OBAT, t_resep_detail.SEDIAAN, t_resep_detail.ATURAN_PAKAI, t_resep_detail.JUMLAH FROM t_resep INNER JOIN t_resep_detail ON (t_resep.NORESEP = t_resep_detail.NORESEP) WHERE t_resep.IDXDAFTAR = ".$idxdaftar." and t_resep.NOMR = '".$nomr."'" ;
...
<table>
 <tr>
  ...
  <tr>
  <td>Nama Obat</td>
  <td><input type="text" class="text" name="nm_barang"  id="nm_barang" style="width:300px" /></td>
  </tr>
<tr>
  <td>Sediaan</td>

...
<p>
 Paket Laboratorium &nbsp;
 <select name="s_paketlab" id="s_paketlab" onchange="javascript: MyAjaxRequest('paketlab','ugd/lab/change_paketlab.php?paket='+this.value+'&idx='+<?=$_GET['idx']?>); return false;" >
   <option value="-"> -- </option>

...
<form name="formsavelab" id="formsavelab" method="post" action="ugd/lab/saveorderlab.php">
...
?>
 ...
 <br />
 <table>
 <tr><td><input type="submit" class="text" value="S i m p a n" submit="submitform (document.getElementById('formsavelab'),'ugd/lab/saveorderlab.php','validlab',validatetask);return false;" />
 </td></tr>
 </table>

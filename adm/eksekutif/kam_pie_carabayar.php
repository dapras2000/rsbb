...
$sql="select date_format(a.tglreg,'%d-%m-%Y') as tglreg, m.nama,
...
inner join m_carabayar m on (a.kdcarabayar=m.kode)
...
$graph->addData($total); 
$graph->setTitle("TOTAL PASIEN KAMAR OPERASI BERDASAR CARA BAYAR [JUMLAH ".$v_total." PASIEN]");

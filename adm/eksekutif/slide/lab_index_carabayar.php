...
<div id="frame" style="width:100%">
	<div id="frame_title"><h3>Rekap Laboratorium Per Carabayar</h3></div>
<?php
$tgl_kunjungan = "";
...
<form name="formsearch" method="get" >
  ...
  <tr>
    ...
    <td><input type="submit" value="Cari" class="text"/>
      <input type="hidden" name="link" value="privatelab1" /></td>
  </tr>
</table>
...
<table  style="font-size:12px;" border="1" align="center" class="tb" cellpadding="1" cellspacing="1">
  <tr>
    ...
    <th colspan="4">Pendapatan Laboratorium</th>
...
?>
  ...
  <?php  $tot_jkl=0;$tot_jkp=0;
       ...
       $sql="CALL pr_eksekutif_lab_carabayar_rajal('".$tgl_kunjungan."','".$tgl_kunjungan2."')";
       $rs=mysql_query($sql);
...
<p><form action="adm/eksekutif/slide/lab_carabayar_xls.php" method="get">

...
inner join (select distinct idxdaftar from t_radiologi l where NO_FILM is not null) l on (a.idxdaftar = l.idxdaftar)
...
$graph->addData($total); 
$graph->setTitle("TOTAL PASIEN RADIOLOGI BERDASAR CARA BAYAR [JUMLAH ".$v_total." PASIEN]");

...
// 				}
			...
			$this->header .= '
				&nbsp;
				<img src="icd/images/asc.png" title="Ascendent" style="cursor: pointer;" '.str_replace("ORDERING","ASC",$events[$ind]).'>
				<img src="icd/images/desc.png" title="Descendent" style="cursor: pointer;" '.str_replace("ORDERING","DESC",$events[$ind]).'>
			</th>';
		...
		if($edit)
			$row .= '
					<td align="center" width="5%">
						<a href="?" onClick="xajax_edit(\''.$arr[0].'\',\''.$table.'\');return false;"><img src="icd/images/edit.png" border="0"></a>
					</td>';
		if($delete)
			$row .= '
					<td align="center" width="5%">
						<a href="?" onClick="if (confirm(\'Yakin akan dihapus?\'))  xajax_delete(\''.$arr[0].'\',\''.$table.'\',\''.$divName.'\');return false;"><img src="icd/images/trash.png" border="0"></a>
					</td>';
			...
			<tr>
				<th colspan="'.$this->n_cols.'">
					...
					if($next_rows < $this->numRows){
						$this->footer .= '<a href="?" onClick=\'xajax_showGrid('.$next_rows.','.$this->limit.',"'.$this->filter.'","'.$this->content.'","'.$this->order.'");return false;\'>Sesudah ></a>';
					}else{
						$this->footer .= 'Sesudah >';
					}
		...
		$table = '
			...
			<tr>
				<th align="right" valign="center">
					<img src="icd/images/close.png" onClick=\'javascript:document.getElementById("formDiv").style.visibility="hidden";return false;\' title="Close Window" style="cursor: pointer; height: 16px;">
				</th>
			</tr>

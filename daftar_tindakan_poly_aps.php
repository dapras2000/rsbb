...
<h3>
<?php echo getNamaPoly($_REQUEST['poly']); ?>
</h3>
<?php
		...
		if(mysql_num_rows($sql) > 0):
			...
			while($data = mysql_fetch_array($sql)){
				...
				<tr>
					...
					<td>';
					$s	='select distinct a.kddokter, b.NAMADOKTER from m_dokter_jaga a join m_dokter b where a.kddokter = b.KDDOKTER and a.kdpoly = "'.$kdunit.'"';
					$s	= mysql_query($s);

...
<div align="center">
  <table width="991" border="0" cellspacing="0" class="tb">
    <tr>
      <td width="208" rowspan="5"><div align="center"><img src="../img/log.png" width="110" height="104" /></div></td>
      <td colspan="2"><div align="center"><?=strtoupper($header1)?></div></td>
    </tr>
    <tr>
      <td colspan="2"><div align="center"><?=strtoupper($header2)?></div></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="2" rowspan="2"><strong><u>SURAT RUJUKAN</u></strong></td>
      <? $tgl = date("d M Y")?>    

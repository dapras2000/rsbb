...
<div align="center">
	<div id="frame" style="width:95%;">
    	<div id="frame_title"><h3>Rekap Sensus Pendaftaran Rajal</h3></div>
...
<table class="tb">
  ...
  <tr>
    <td colspan="2" ><input type="hidden" name="link" value="140R" />
      <input type="submit" value="CARI" class="text" /></td>
  </tr>
</table>
</form>
JURNAL PENDAFTARAN RAWAT JALAN 
<br>PERIODE BULAN <?= $_GET["kdbulan"]?> Tahun <?=$_GET["tahun"] ?>
<div style="overflow:scroll; width:95%; height:400px;">
<p>
<form action="report_rm/RekapanPendaftaranRajal_xls.php" method="get">
				 <input type="hidden" name="tahun" id="tahun" value=<?=$_GET["tahun"]?> />
                <input type="hidden" name="kdbulan" id="kdbulan" value=<?=$_GET["kdbulan"]?> />

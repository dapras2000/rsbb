...
<table class="tb">
  ...
  <tr>
    <td colspan="2" ><input type="hidden" name="link" value="141R" />
      <input type="submit" value="CARI" class="text" /></td>
  </tr>
</table>
</form>
<p>DATA PASIEN RAWAT JALAN <br />
  PERIODE BULAN
    <?= $_GET["kdbulan"]?>
Tahun
<?=$_GET["tahun"] ?>
...
GROUP BY b.nama";
?>
<form action="report_rm/RekapanPolyRawatJalan_xls.php" method="get">
				 <input type="hidden" name="tahun" id="tahun" value=<?=$thn?> />
                <input type="hidden" name="kdbulan" id="kdbulan" value=<?=$bln?> />                

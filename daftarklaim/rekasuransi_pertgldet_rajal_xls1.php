...
<div align="center">
	<div id="frame" style="width:100%;">
		<div id="frame_title">
			<h3> DETIL KLAIM ASURANSI TANGGAL <?php echo $_REQUEST['tgl'];?></h3></div>
...
JOIN m_carabayar ON m_carabayar.kode = a.CARABAYAR  WHERE TGLBAYAR = "'.$tgl.'" '.$nomr.' '.$crb.' AND a.STATUS = "LUNAS" ORDER BY b.kodetarif, b.unit, b.nomr ';

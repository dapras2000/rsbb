...
<div align="center">
	<div id="frame" style="width:100%;">
		<div id="frame_title">
			<h3> DETIL REKAP ASURANSI RANAP TANGGAL <?php echo $_REQUEST['tgl'];?> </h3></div>
...
JOIN m_carabayar ON m_carabayar.kode = b.CARABAYAR  WHERE TGLBAYAR = "'.$tgl.'" AND b.CARABAYAR NOT IN (1) '.$crb.$nomr.' AND a.STATUS = "LUNAS" ORDER BY a.NOBILL ASC';
            ...
            NOMR <input type="text" name="nomr" class="text" value="<?php echo $_REQUEST['nomr'];?>" />
                 ...
                 <input type="hidden" name="link" id="tgl" value="144_ranap_pertanggal_det" /> 
                 <input type="hidden" name="carabayar" id="carabayar" value="<?php echo $_REQUEST['carabayar'];?>" /> 
            	 <input type="submit" name="submit" value="Cari" />
            </form>
            <form action="daftarklaim/rekasuransi_pertgldet_ranap_xls.php" method="get">
                <input type="hidden" name="tgl" id="tgl" value="<?=$tgl?>" />

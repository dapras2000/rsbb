...
<?php
		...
		$q_pasien	= "select a.NOMR, b.NAMA, b.ALAMAT, b.JENISKELAMIN, b.TGLLAHIR, c.NAMA as CARABAYAR, a.KDCARABAYAR, a.IDXDAFTAR, a.KDPOLY, d.nama as nama_poly,a.KDDOKTER from t_pendaftaran a, m_pasien b, m_carabayar c, m_poly d where a.NOMR = b.NOMR and a.KDCARABAYAR = c.KODE and a.KDPOLY = d.kode and a.NOMR = '".$_REQUEST['nomr']."' and a.IDXDAFTAR = '".$_REQUEST['idxdaftar']."'";

...
<div align="center">
    ...
    <div id="frame_title"><h3>PEMAKAIAN OBAT</h3></div>

<form name="terimabarang" id="terimabarang" action="operasi/orderbarang/addbarangpengeluaran.php" method="post" >
<fieldset class="fieldset">
<table class="tb" align="left">
<tr>
  <td colspan="2">&nbsp;<input type="radio" name="j_br" id="j_br1" value="1" checked="checked"  />&nbsp;Obat&nbsp;<input type="radio" name="j_br" id="j_br2" value="1" />&nbsp;BHP</td>
</tr>
<tr>
...
<tr>
 <td>No Batch</td>
 <td><input type="text" name="no_batch"  id="no_batch" class="text" /></td>
</tr>
...
<tr>
 ...
 <td height="26"><input type="submit" class="text" value="A d d" onclick="submitform (document.getElementById('terimabarang'),'operasi/orderbarang/addbarangpengeluaran.php','validbarang',validatetask); 
 ...
 return false;"/></td>
 <td align="right"><a href="index.php?link=206&idoperasi=<? echo $_GET['idxorder'];?>&tanggal=<? echo $_GET['tanggal'];?>" class="text">K E M B A L I</a></td>
</tr>
</table>
</fieldset>

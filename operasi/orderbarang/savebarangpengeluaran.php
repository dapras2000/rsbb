				  ...
				  while($data = mysql_fetch_array($row)){
					  ...
					  @mysql_query("INSERT INTO t_pengeluaran_barang (NIP, KDUNIT, kodebarang,
								   ...
								   VALUES('$nip', '$kdunit', '$kd_barang', '$tgl_keluar',
										  $jml_keluar, $idxdaftar, '$nomr')") or die(mysql_error());
					...
					VALUES ('$kd_barang', '$tgl_keluar', '$jml_keluar', '$saldo', '$kdunit')")or die(mysql_error());
					  ...
					  @mysql_query("INSERT INTO t_operasi_barang(IDXOPERASI, KD_BARANG, NO_BATCH, JUMLAH)
							VALUES('".$idxorder."', '$kd_barang', NULL, '$jml_keluar')") or die(mysql_error());
				  }
			}

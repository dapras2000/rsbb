...
<div align="center" style="width:390px; float:left; margin-right:10px;">
	<div id="frame" style="width:100%;">
		...
		<div align="right" style="margin:5px;">
			...
			mysql_query('delete from t_operasi_tindakan_medis where idoperasi = "'.$_REQUEST['idoperasi'].'" and status = "0"');
...
<div align="center" style="width:590px; float:left;">
    <div id="frame" style="width: 100%;">
        ...
        <div align="right" style="margin:5px;">
			<ul class="tabs">
			<input type="hidden" name="idoperasi" id="idoperasi" value="<?php echo $_REQUEST['idoperasi'];?>"/>
    	<?php
		$sql=mysql_query('SELECT * FROM m_tarif2012 WHERE kode_lampiran = "04" AND LENGTH(kode_tindakan) = "5"');
		$i = 1;
		...
		$h	= mysql_query($q);
		//function load_dokter($query,$name='',$id=''){
			$vb = '';
		...
		$sql2=mysql_query('SELECT * FROM m_tarif2012 WHERE kode_lampiran = "04" AND LENGTH(kode_tindakan) = "5"');
			$i = 1;

...
<table width="95%" class="tb" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="221">NOMR (dari admission)</td>
    <td width="266"><label>
    <input name="nomroperasi" type="text" id="nomroperasi" size="10" />
    </label></td>
    <td width="131">&nbsp;</td>
    <td width="404">&nbsp;</td>
  </tr>
    ...
    <td><label>
      <select class="text" name="jenisanastesi" id="jenisanastesi" onchange="showKab()">
       ...
       <option value="REGIONAL">REGIONAL</option>
        <option value="BLOG PERIFER">BLOG PERIFER</option>
  ...
  <tr>
    <td><label></label>
      <label>Metode Anastesi</label></td>
    <td><select name="metodeanastesi" id="metodeanastesi" class="text">
    </select></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>

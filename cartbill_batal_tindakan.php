...
FROM t_billrajal a, t_bayarrajal b WHERE a.NOBILL = b.NOBILL AND a.IDXBILL ='.$_REQUEST['nobill'];
...
if($mysql){
	...
	mysql_query('select * from t_billrajal where idxbill = "'.$_REQUEST['nobill'].'"');
...
<div id="global_print" style="font-family:'Arial', Gadget, sans-serif">
    ...
    <?php
	$sql = mysql_query("SELECT a.kode_tindakan AS kode, a.nama_tindakan AS nama_jasa, b.qty, b.TARIFRS FROM m_tarif2012 a, t_billrajal b WHERE a.kode_tindakan=b.KODETARIF AND b.IDXBILL='".$_REQUEST['nobill']."' AND b.QTY>0");
	$total	= 0;
...
<tr><td>
	...
	$sql = mysql_query("SELECT a.kode_tindakan AS kode, a.nama_tindakan AS nama_jasa, b.qty, b.TARIFRS FROM m_tarif2012 a, t_billrajal b WHERE a.kode_tindakan=b.KODETARIF AND b.IDXBILL='".$_REQUEST['nobill']."'");
	$total	= 0;
	while($data = mysql_fetch_array($sql)){
...
mysql_query('DELETE FROM t_billrajal where idxbill = "'.$_REQUEST['nobill'].'"');
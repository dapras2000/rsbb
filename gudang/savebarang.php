...
if($_POST['kdbarang']==""){
	...
	$sql = "INSERT INTO m_barang(nama_barang, group_barang, farmasi, satuan, harga, no_batch, expiry, pabrik)
		VALUES ('$nmbarang', '$group', '$farmasi', '$satuan', $harga, '$nobatch', '$expiry','$pabrik')";
  		$get = mysql_query($sql);
		if($get){

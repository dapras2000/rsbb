...
class PS_Pagination2 {
	...
	function PS_Pagination2($connection, $sql, $rows_per_page = 10, $links_per_page = 5, $append = "") {
		...
		$this->append = $append;
		$this->jen = $_GET['jen'];
		//$this->php_self =$_SERVER['REQUEST_URI']."&";
		 $this->php_self ="index.php?link=26&search=".$_GET['search']."&";
		if(isset($_GET['page'])) {

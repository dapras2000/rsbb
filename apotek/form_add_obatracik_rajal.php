...
jQuery(document).ready(function(){
	...
	jQuery('#add_obat_racik').click(function(){
		...
		jQuery.post('<?php echo _BASE_;?>apotek/simpan_obat_racikan_tmpracikan.php',jQuery('#obat_racikan').serialize(),function(data){
			jQuery('#table_list_racikan').load('<?php echo _BASE_;?>apotek/load_obat_racikan_tmpracikan_rajal.php?txtIdxDaftar='+idx+'&noracik='+xx);
...
<tr>
	<td>Nama Obat</td><td><input type="text" name="nama_obat_racik" size="50" id="nama_obat_racik"  class="text"/>
    					  <input type="hidden" name="kode_obat_racik" id="kode_obat_racik" />

...
<div align="center">
<div id="frame">
	<div id="frame_title"><h3>Form Edit</h3></div>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center" class="tb">
    ...
    <tr valign="baseline">
      ...
      <label>
      <a href="index.php?link=176&indek=<?=$row_rse['id_admission'];?>&historyback=<?php echo $_REQUEST['historyback'];?>"><input class="text" type="button" name="button" id="button" value="Pilih Ruang"/></a>      </label></td>
    </tr>
    <tr valign="baseline">

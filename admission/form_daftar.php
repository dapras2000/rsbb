...
jQuery(document).ready(function() {
	...
	jQuery('#form_admission').validation();
});
</script>

 <?
$query="SELECT a.NOMR, a.KDCARABAYAR, a.POLYPENGIRIM, a.KDRUJUK, a.IDXDAFTAR, a.TGLORDER, b.NAMA, b.ALAMAT, b.TEMPAT, b.TGLLAHIR, b.JENISKELAMIN, c.NAMA AS POLY, d.NAMA AS RUJUKAN, e.NAMADOKTER, e.KDDOKTER, f.NAMA AS CARABAYAR
		FROM t_orderadmission a, m_pasien b, m_poly c, m_rujukan d, m_dokter e, m_carabayar f
		WHERE a.IDXORDER='".$_GET['no']."' AND a.NOMR=b.NOMR AND a.POLYPENGIRIM=c.KODE AND a.KDRUJUK=d.KODE AND a.DRPENGIRIM=e.KDDOKTER AND a.KDCARABAYAR=f.KODE";
...
<form id="form_admission" name="form_admission" method="post" action="index.php?link=174">
<input type="hidden" name="idxorder" value="<?php echo $_REQUEST['no']; ?>" />
  <table width="100%" border="0" align="center" class="tb">
    ...
    <tr>
      ...
      <td>Ruang Rawat:</td>
      <td><a href="index.php?link=173&amp;no=<?=$_GET['no'];?>">
...
<tr>
    ...
    <tr>
      ...
      <td><label> Rp.
        <input type="text" name="deposit" class="text" id="deposit" value="0" />
        #</label></td>
      </tr>
    <tr>
      <td>Asal Pasien</td>
    ...
    <tr>
	  ...
	  <? 
			...
			$sql_dokter = "SELECT DISTINCT NAMADOKTER, KDDOKTER FROM m_dokter GROUP BY NAMADOKTER ORDER BY NAMADOKTER ASC";

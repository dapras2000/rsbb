        ...
        <div align="right" style="margin:5px;">
                ...
                <table class="tb">
                    ...
                    <tr><td colspan="4" ><input type="checkbox" name="pulang" value="1"
                            <?php if(!empty($_GET['pulang'])) echo "checked=checked";  ?>
                                                />&nbsp;Pulang&nbsp;&nbsp;
                            <input type="hidden" name="link" value="171" />
            ...
            <div id="table_search">
                <table border="0" class="tb" cellpadding="1" cellspacing="1">
                    ...
                    $sql="SELECT a.id_admission, a.nomr, a.statusbayar, a.masukrs, a.noruang, a.nott, a.icd_masuk, a.NIP, a.tgl_pindah,
       b.nama as namapasien, b.alamat, b.tgllahir, a.keluarrs,
	   c.nama as jenisbayar,
	   d.jenis_penyakit,
	   e.nama
FROM t_admission a
...
inner join   m_ruang e on a.noruang=e.no ".$search;
                    ...
                    $NO=0;
                    $pager = new PS_Pagination($connect, $sql, 15, 5, "tgl_kunjungan=".$tgl_kunjungan."&ruang=".$ruang."&nama=".$nama."&nomr=".$nomr,"index.php?link=171&");
    ...
    ($hal*15)+$NO;?></td>
                        ...
                        <td><a href="index.php?link=175&indeks=<?php echo $data['id_admission']; ?>"><input class="text" type="button" name="ubahadmission" value="Ubah Admission"/></a></td>
                        <!-- <td><a href="admission/hapusdaftar.php?id=<?= $data['id_admission'];?>" ><input class="text" type="button" name="hapusadmission" value="Hapus Admission" onClick="javascript:return confirm('Anda yakin ingin menghapus Pasien  ini?\n NOMR PASIEN : <? //echo $data['nomr'];?>')"/></a> -->
                        </td>
                        <td>
                             <a href="cetak_kartupasien_ranap.php?NOMR=<?=$data['nomr'];?>&info=<?=$data['nama'];?>&info2=<?=$data['nott'];?>" target="_blank"><input type="button" value="Cetak Label" class="text" /></a>
                        </td>
                    </tr>
                        <?	}

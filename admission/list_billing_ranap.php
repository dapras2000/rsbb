...
<div align="center">
    ...
    ($hal*15)+$NO;?></td>
                        ...
                        <td><a href="index.php?link=detail_billing_ranap&id=<?= $data['id_admission'];?>" ><input class="text" type="button" name="hapusadmission" value="Detail"/></a></td>
                    </tr>
                        <?	}

...
$myquery = 'SELECT a.nomr AS NOMR, b.NAMA, a.TGLBILLING, a.TGLBAYAR, a.JAMBAYAR,a.DEPOSIT,a.TOTASKES,a.TOTCOSTSHARING
FROM t_bayarranap a
...
<div id="global_print" style="font-family:'Arial', Gadget, sans-serif">
    ...
    <?php
	$sql = "SELECT g.nama_tindakan, h.NAMADOKTER, i.nama AS CARABAYAR, f.QTY, f.TARIFRS, f.QTY * f.TARIFRS AS TOTAL, f.TANGGAL
FROM t_billranap f

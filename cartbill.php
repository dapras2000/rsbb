...
?>
<tr style="border:1px;"><td colspan="6"> No.Bill : <?php echo $data2['NOBILL']; ?>   <input type="button" name="print" value="Print" class="text print" id="print_<?php echo $data2['NOBILL']; ?>" rel="<?php echo $userdata['IDXDAFTAR']; ?>" svn="<?php echo $data2['NOBILL']; ?>" style="display:block; float:right;"/><div id="callback_<?php echo $data2['NOBILL']; ?>" style="float:right;"></div>
		</td>
</TR>	
  </table>
</fieldset>

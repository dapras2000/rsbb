...
inner join t_billrajal d on a.idxdaftar=d.idxdaftar aND a.kdpoly=d.kdpoly and a.kdpoly in(9) and d.kodetarif in(
...
<table width="518" border="1" class="tb">
  <tr>
    <th colspan="6">Pemeriksaan UGD</th>
  </tr>
  <tr>
    <td width="78">Poly</td>
...
$qry = mysql_query("select a.kdpoly,c.nama as poly, a.kddokter,b.namadokter,sum(d.tarifrs*d.qty) as tarif ,
					...
					where a.kddokter=b.kddokter and a.kdpoly=c.kode and a.idxdaftar=d.idxdaftar and ".$search."
						 aND a.kdpoly=d.kdpoly and a.kdpoly in(9) and kodetarif in ('010415') and d.kodetarif=e.kode and a.kdcarabayar=1
					group by a.kdpoly,c.nama, a.kddokter,b.namadokter,e.nama_jasa 
					order by a.kdpoly") or die (mysql_error());
?> 
...
$qry = mysql_query("select a.kdpoly,c.nama as poly, a.kddokter,b.namadokter,sum(d.tarifrs*d.qty) as tarif ,
					   e.nama_jasa, 0.7*sum(d.tarifrs*d.qty) as jsdr, 0.1*sum(d.tarifrs*d.qty) as manajemen,  
					   0.125*sum(d.tarifrs*d.qty) as 	pendukung,0.075*sum(d.tarifrs*d.qty) as asisten, f.nama as pasien 
					from t_pendaftaran a, m_dokter b, m_poly c, t_billrajal d, m_tarif e, m_pasien f
					where a.kddokter=b.kddokter and a.kdpoly=c.kode and a.idxdaftar=d.idxdaftar and ".$search."
						 aND a.kdpoly in(9) and kodetarif like '0108%' and d.kodetarif=e.kode and a.kdcarabayar=1 and a.nomr=f.nomr
					group by a.kdpoly,c.nama, a.kddokter,b.namadokter,e.nama_jasa, f.nama 
					order by a.kdpoly") or die (mysql_error());
?>                    
<table width="816" border="1" class="tb">
  <tr>
    <th colspan="9">Tindakan  paket medis IIIA/ IIIB/ IIIC</th>
  </tr>
  <tr>
...
<?php 
$qry = mysql_query("select a.kdpoly,c.nama as poly, a.kddokter,b.namadokter,sum(d.tarifrs*d.qty) as tarif ,
e.nama_jasa, 0.7*sum(d.tarifrs*d.qty) as jsdr, 0.1*sum(d.tarifrs*d.qty) as manajemen,  0.20*sum(d.tarifrs*d.qty) as pendukung
from t_pendaftaran a, m_dokter b, m_poly c, t_billrajal d, m_tarif e
 where a.kddokter=b.kddokter and a.kdpoly=c.kode and a.idxdaftar=d.idxdaftar and ".$search." and a.kdpoly =9 and kodetarif in('01050201','01050202','01050203','01050204','01050205') and d.kodetarif=e.kode and a.kdcarabayar=1 
 group by a.kdpoly,c.nama, a.kddokter,b.namadokter,e.nama_jasa 
order by a.kdpoly") or die (mysql_error());
?>                    
...
$qry = mysql_query("select a.kdpoly,c.nama as poly, a.kddokter,b.namadokter,sum(d.tarifrs*d.qty) as tarif ,
					...
					from t_pendaftaran a, m_dokter b, m_poly c, t_billrajal d, m_tarif e
					where a.kddokter=b.kddokter and a.kdpoly=c.kode and a.idxdaftar=d.idxdaftar and ".$search."
						 aND a.kdpoly=d.kdpoly and a.kdpoly in(9) and kodetarif in ('010415') and d.kodetarif=e.kode and a.kdcarabayar=2
					group by a.kdpoly,c.nama, a.kddokter,b.namadokter,e.nama_jasa 
					order by a.kdpoly") or die (mysql_error());
?>
    <table width="565" border="1" class="tb">
...
$qry = mysql_query("select a.kdpoly,c.nama as poly, a.kddokter,b.namadokter,sum(d.tarifrs*d.qty) as tarif ,
					...
					from t_pendaftaran a, m_dokter b, m_poly c, t_billrajal d, m_tarif e
					where a.kddokter=b.kddokter and a.kdpoly=c.kode and a.idxdaftar=d.idxdaftar and ".$search."
						 aND a.kdpoly in(9) and kodetarif like '0108%' and d.kodetarif=e.kode and a.kdcarabayar=2
					group by a.kdpoly,c.nama, a.kddokter,b.namadokter,e.nama_jasa 
					order by a.kdpoly") or die (mysql_error());
?>
...
<div align="center">
  <div id="frame">
    <div id="frame_title">
      <h3>C. Pasien Jamkesmas</h3></div><table width="518" border="1" class="tb">
      <tr>
        <th colspan="6">Pemeriksaan UGD</th>
      </tr>
      <tr>
...
$qry = mysql_query("select a.kdpoly,c.nama as poly, a.kddokter,b.namadokter,sum(d.tarifrs*d.qty) as tarif ,
					...
					from t_pendaftaran a, m_dokter b, m_poly c, t_billrajal d, m_tarif e
					where a.kddokter=b.kddokter and a.kdpoly=c.kode and a.idxdaftar=d.idxdaftar and ".$search."
						 aND a.kdpoly=d.kdpoly and a.kdpoly in(9) and kodetarif in ('010415') and d.kodetarif=e.kode and a.kdcarabayar=3
					group by a.kdpoly,c.nama, a.kddokter,b.namadokter,e.nama_jasa 
					order by a.kdpoly") or die (mysql_error());
?>
    <table width="565" border="1" class="tb">
...
$qry = mysql_query("select a.kdpoly,c.nama as poly, a.kddokter,b.namadokter,sum(d.tarifrs*d.qty) as tarif ,
					...
					from t_pendaftaran a, m_dokter b, m_poly c, t_billrajal d, m_tarif e
					where a.kddokter=b.kddokter and a.kdpoly=c.kode and a.idxdaftar=d.idxdaftar and ".$search."
						 aND a.kdpoly in(9) and kodetarif like '0108%' and d.kodetarif=e.kode and a.kdcarabayar=3
					group by a.kdpoly,c.nama, a.kddokter,b.namadokter,e.nama_jasa 
					order by a.kdpoly") or die (mysql_error());
?>
    <table width="728" border="1" class="tb">
...
<div align="center">
  <div id="frame">
    <div id="frame_title">
      <h3>D. Pasien SKTM</h3></div><table width="518" border="1" class="tb">
      <tr>
        <th colspan="6">Pemeriksaan UGD</th>
      </tr>
      <tr>
...
$qry = mysql_query("select a.kdpoly,c.nama as poly, a.kddokter,b.namadokter,sum(d.tarifrs*d.qty) as tarif ,
					...
					from t_pendaftaran a, m_dokter b, m_poly c, t_billrajal d, m_tarif e
					where a.kddokter=b.kddokter and a.kdpoly=c.kode and a.idxdaftar=d.idxdaftar and ".$search."
						 aND a.kdpoly=d.kdpoly and a.kdpoly in(9) and kodetarif in ('010415') and d.kodetarif=e.kode and a.kdcarabayar=4
					group by a.kdpoly,c.nama, a.kddokter,b.namadokter,e.nama_jasa 
					order by a.kdpoly") or die (mysql_error());
?>
    <table width="565" border="1" class="tb">
...
$qry = mysql_query("select a.kdpoly,c.nama as poly, a.kddokter,b.namadokter,sum(d.tarifrs*d.qty) as tarif ,
					...
					from t_pendaftaran a, m_dokter b, m_poly c, t_billrajal d, m_tarif e
					where a.kddokter=b.kddokter and a.kdpoly=c.kode and a.idxdaftar=d.idxdaftar and ".$search."
						 aND a.kdpoly in(9) and kodetarif like '0108%' and d.kodetarif=e.kode and a.kdcarabayar=4
					group by a.kdpoly,c.nama, a.kddokter,b.namadokter,e.nama_jasa 
					order by a.kdpoly") or die (mysql_error());
?>
    <table width="728" border="1" class="tb">
...
$qry = mysql_query("select a.kdpoly,c.nama as poly, a.kddokter,b.namadokter,sum(d.tarifrs*d.qty) as tarif ,
					...
					from t_pendaftaran a, m_dokter b, m_poly c, t_billrajal d, m_tarif e
					where a.kddokter=b.kddokter and a.kdpoly=c.kode and a.idxdaftar=d.idxdaftar and ".$search."
						 aND a.kdpoly=d.kdpoly and a.kdpoly in(9) and kodetarif in ('010415') and d.kodetarif=e.kode and a.kdcarabayar=5
					group by a.kdpoly,c.nama, a.kddokter,b.namadokter,e.nama_jasa 
					order by a.kdpoly") or die (mysql_error());
?>
    <table width="565" border="1" class="tb">
...
$qry = mysql_query("select a.kdpoly,c.nama as poly, a.kddokter,b.namadokter,sum(d.tarifrs*d.qty) as tarif ,
					...
					from t_pendaftaran a, m_dokter b, m_poly c, t_billrajal d, m_tarif e
					where a.kddokter=b.kddokter and a.kdpoly=c.kode and a.idxdaftar=d.idxdaftar and ".$search."
						 aND a.kdpoly in(9) and kodetarif like '0108%' and d.kodetarif=e.kode and a.kdcarabayar=5
					group by a.kdpoly,c.nama, a.kddokter,b.namadokter,e.nama_jasa 
					order by a.kdpoly") or die (mysql_error());
?>
    <table width="728" border="1" class="tb">

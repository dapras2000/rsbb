...
function createGrid($start = 0, $limit = 1, $filter = null, $content = null, $order = null, $divName = "grid", $ordering = ""){
	...
	$eventHeader = array();
	$eventHeader[]= 'onClick=\'xajax_showGrid(0,'.$limit.',"'.$filter.'","'.$content.'","namadokter","'.$divName.'","ORDERING");return false;\'';
	$eventHeader[]= 'onClick=\'xajax_showGrid(0,'.$limit.',"'.$filter.'","'.$content.'","namaprofesi","'.$divName.'","ORDERING");return false;\'';
	$eventHeader[]= 'onClick=\'xajax_showGrid(0,'.$limit.',"'.$filter.'","'.$content.'","poly","'.$divName.'","ORDERING");return false;\'';
	//$eventHeader[]= 'onClick=\'xajax_showGrid(0,'.$limit.',"'.$filter.'","'.$content.'","kdpoly","'.$divName.'","ORDERING");return false;\'';

	// Select Box: fields table.
	$fieldsFromSearch = array();
	$fieldsFromSearch[] = 'namadokter';
	$fieldsFromSearch[] = 'namaprofesi';
	$fieldsFromSearch[] = 'poly';
	//$fieldsFromSearch[] = 'kdpoly';

	// Selecct Box: Labels showed on search select box.
	$fieldsFromSearchShowAs = array();
	$fieldsFromSearchShowAs[] = "Nama Dokter";
	$fieldsFromSearchShowAs[] = "Profesi";
	$fieldsFromSearchShowAs[] = "Nama Poly";
	...
	$table->addRowSearch("m_dokter",$fieldsFromSearch,$fieldsFromSearchShowAs);
	...
	// Change here by the name of fields of its database table
		...
		$rowc[] = $row['kddokter'];
		$rowc[] = $row['namadokter'];
		$rowc[] = $row['namaprofesi'];
		$rowc[] = $row['poly'];
		$table->addRow("m_dokter",$rowc,1,1,$divName,$fields);
 	}

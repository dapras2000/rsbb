 ...
 * 
 * @package xajax
 * @version $Id: xajax.inc.php,v 1.1.1.1 2006/09/23 01:39:26 jjvema Exp $
...
class xajax
{
	...
	function getJavascriptInclude($sJsURI="", $sJsFile=NULL)
	{
		...
		// JJVEMA - Puse fijo el URI de la busqueda de los JavaScript includes
		//$sJsURI = "/includes/";
	...
	{	
		...
		if (!file_exists($realJsFile)) {
			...
			require("icd/".dirname(__FILE__)."/xajaxCompress.php");

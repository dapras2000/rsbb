...
class ScrollTable{
	...
	*/
	...
	function setHeader($class,$headers,$attribs,$events,$detail=true,$edit=true,$delete=true){
...
// 				}
	...
	*/
	...
	function addRow($table,$arr,$detail=true,$edit=true,$delete=true,$divName="grid",$fields=null){
	   ...
	   foreach ($arr as $key => $value) {
		...
		if($detail)
			$row .= '
					<td align="center" width="5%">
						<a href="?" onClick="xajax_detail(\''.$arr[0].'\',\''.$table.'\');return false;"><img src="images/add.png" border="0"></a>
					</td>';
		if($edit)
			$row .= '
					<td align="center" width="5%">
		...
		if($delete)
			$row .= '
					<td align="center" width="5%">
	<a href="?" onClick="if (confirm(\''.$arr[1].' yakin akan dihapus ?\'))  xajax_delete(\''.$arr[0].'\',\''.$table.'\',\''.$divName.'\');return false;"><img src="images/trash.png" border="0"></a>
					</td>';

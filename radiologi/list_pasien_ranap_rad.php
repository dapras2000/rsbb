...
<div align="center">
    <div id="frame" style="width: 100%;">
        <div id="frame_title"><h3>LIST PASIEN RAWAT INAP</h3></div>
    ...
    echo $nama;
                    ...
                    <tr>
                        ...
                        <td><input type="submit" value="Cari" class="text"/>
                            <input type="hidden" name="link" value="list_pasien_ranap_rad" /></td>
                    </tr>
                </table>
            ...
            <div id="table_search">
				...
				<tr align="center"><th>No</th><th>TGL Masuk</th><th>No RM</th><th>Nama Pasien</th><th>Alamat</th><th>Poli/ Ruang</th><th>Dokter Pengirim</th><th width="70px">Cara Bayar</th><th width="200px">&nbsp;</th></tr>
					...
					where a.noruang != 0 '.$search.' and (a.keluarrs is null or DATE_FORMAT(a.keluarrs,"%Y/%m/%d") = "0000/00/00") order by a.masukrs asc';
                    ...
                    <?php
                        ...
                        <td>
						<?php
							echo '<a href="'._BASE_.'index.php?link=72formorderrad_ranap&nomr='.$data['nomr'].'&idx='.$data['id_admission'].'"><input type="button" value="TAMBAH PEMERIKSAAN" class="text"/></a>';
						?>
                        </td>
                    </tr>
                        <?	$i++;

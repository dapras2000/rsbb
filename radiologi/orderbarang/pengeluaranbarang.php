...
<div align="center">
    ...
    <div id="frame_title"><h3>PENGELUARAN BARANG FOTO RADIOLOGI</h3></div>
...
<tr>
  <td width="143">No. Foto</td>
  <td width="307"><input type="text" name="no_foto" value="<?=$_GET['nofoto']?>" readonly="readonly" class="text" style="width:165px"/></td>
</tr>
<tr>
  <td colspan="2">&nbsp;<input type="radio" name="j_br" id="j_br1" value="1" checked="checked"  />&nbsp;Obat&nbsp;<input type="radio" name="j_br" id="j_br2" value="1" />&nbsp;Alkes</td>
  </tr>
<tr>
 <td>Nama Barang</td>
 <td><input type="text" name="nm_barang" id="nm_barang" onkeypress="autocomplete_barang_rad(this.value, event)"  onblur="document.getElementById('autocompletediv'); Efect.appear('autocompletediv'); " class="text" style="width:300px"/></td>
</tr>
<tr>
 <td>Kode Barang</td>

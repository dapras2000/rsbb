...
<div align="center">
    <div id="frame" style="width:100%;">
        <div id="frame_title"><h3>LIST ORDER RADIOLOGI</h3>
        </div>
                ...
                <table border="0" cellspacing="0" class="tb">
                    ...
                    <tr>
                        ...
                        <td><input type="submit" value="Cari" class="text"/>
                            <input type="hidden" name="link" value="r03" /></td>
                    </tr>
                </table>
            ...
            <div id="table_search">
                <table class="tb" width="95%" style="margin:10px;" border="0" cellspacing="1" cellspading="1" title="List Kunjungan Data Pasien Per Hari Ini">
                    <tr align="center">
                        ...
                        <th>Tanggal Order</th>
                        <th>Jenis Photo</th>
                        <th>Diagnosa Dokter Pengirim</th>
			...
			WHERE  t_orderlab.STATUS = '0' ".$search;
                    */
                    ...
                    $sql = "select a.IDXORDERRAD, f.IDXDAFTAR, a.TGLORDER,
                                    a.NOMR, e.NAMA, g.NAMA AS NAMABAYAR,
                            ...
                            where a.IDXDAFTAR = f.IDXDAFTAR
                                    ...
                                    and a.jenisfilm = '' or isnull(a.jenisfilm)  ".$search;
                    $NO=0;
                    $pager = new PS_Pagination($connect, $sql, 15, 5, "tgl_kunjungan=".$tgl_kunjungan."tgl_kunjungan2=".$tgl_kunjungan2."&nama=".$nama."&norm=".$norm,"index.php?link=r03&");
    ...
    ($hal*15)+$NO;?></td>
                        ...
                        <td><a href="index.php?link=r04&amp;idxorder=<?php echo $data['IDXORDERRAD']; ?>"><input type="button" class="text" value="PERIKSA"/></a></td>
                    </tr>
                        <?	}
        ...
        <br />
        <?
        $qry_excel = "SELECT TGLORDER AS TGL_PESAN,
            nama_rad AS JENIS_PHOTO,
            DIAGNOSA AS DIAGNOSA_DOKTER_PENGIRIM,
            ...
            USIA
            FROM view_orderrad WHERE 1 ".$search;
        ?>
...
<div align="left">
    <form name="formprint" method="post" action="gudang/excelexport.php" target="_blank" >
        ...
        <input type="hidden" name="header" value="LIST ORDER RADIOLOGI" />
        <input type="hidden" name="filename" value="list_rad" />

<html>
    ...
    <div align="center">
        <div id="frame" style="width:100%;">
            <div id="frame_title"><h3>FORM FOTO RADIOLOGI</h3></div>
            <form id="formperiksaradiologi" name="formperiksaradiologi" method="post" action="radiologi/updateperiksa.php">
    ...
    echo $psn;
                    ...
                    <tr>
                        ...
                        $thn = date("Y");
                        $bln = date("m");
                        $sql_nourut_m = "SELECT NO_FILM FROM t_radiologi WHERE YEAR(TGLORDER) = '".$thn."' AND MONTH(TGLORDER) = '".$bln."'
...
-->
<select name="petugas[]" id="petugas" class="text petugas">
	<option value=""> -- Pilih Petugas -- </option>
    <?php
	$sql_p = mysql_query('select * from m_petugas_radiologi where status = "1"');
	while($dsql = mysql_fetch_array($sql_p)){
		echo '<option value="'.$dsql['id'].'"> '.$dsql['nama'].' </option>';
	}
    ?>
</select>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <a href="index.php?link=rd1&idxorder=<? echo $_GET['idxorder'];?>&nofoto=<?=$nourut_m?>" target="_self" class="text">
                                Tambah</a></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="2"><input class="text" type="submit" name="submit"  value="Simpan" />

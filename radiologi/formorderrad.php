...
<div align="center" style="width:390px; float:left; margin-right:10px;">
	<div id="frame" style="width: 100%;">
		...
		<div align="right" style="margin:5px;">
			...
			<tr><td width="100px">No RM</td><td width="192"><?php echo $d['NOMR']; ?></td></tr>
		  ...
		  echo $a[years]." tahun ".$a[months]." bulan ".$a[days]." hari"; ?></td></tr>
            ...
            <tr><td>Diagnosa Klinik</td><td><?php echo $d['DIAGNOSA'];?></td></tr>
            </table>
            <br clear="all" />
...
<div align="center" style="width:580px; float:left;">
    <div id="frame" style="width: 100%;">

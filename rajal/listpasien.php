...
WHERE a.nomr=b.nomr AND d.status = 'LUNAS' ".$search." and b.kdpoly='".$_SESSION['KDUNIT']."'
...
ORDER BY b.IDXDAFTAR ASC";
    ...
    <? if($data['keterangan']=="") { ?>
                            ...
                            <a href="cetak_kartupasien_poly.php?NOMR=<?=$data['NOMR'];?>&info=<?=$poly['nama'];?>" target="_blank"><input type="button" value="Cetak Label Pasien" class="text" /></a>
        <? } ?>
                        </td>
                    </tr>
                        <?	}

	...
	///////////////////////////////////////////////////////
	function autocomplete_tarif (thevalue, e){
		theObject = document.getElementById("autocomplete_tarif");
		...
		posx = (findPosX (document.getElementById("nama_tindakan")) + 1);
		posy = (findPosY (document.getElementById("nama_tindakan")) + -155);
		...
		//The location we are loading the page into.
		var objID = "autocomplete_tarif";

		//Take into account the backspace.
		
		if (theextrachar == 8){
			if (thevalue.length == 1){
				var serverPage = "master/m_tarif/include/auto.php";
			} else {
				var serverPage = "master/m_tarif/include/auto.php" + "?sstring=" + thevalue.substr (0, (thevalue.length -1));
			}
		} else {
			var serverPage = "master/m_tarif/include/auto.php" + "?sstring=" + thevalue + String.fromCharCode (theextrachar);
		}
	...
	///////////////////////////////////////////////////////
	function autocomplete_pantri (thevalue, e){
		theObject = document.getElementById("autocomplete_pantri");
		...
		posx = (findPosX (document.getElementById("nm_barang")) + 1);
		posy = (findPosY (document.getElementById("nm_barang")) + -155);
		...
		//The location we are loading the page into.
		var objID = "autocomplete_pantri";

		//Take into account the backspace.
		
		if (theextrachar == 8){
			if (thevalue.length == 1){
				var serverPage = "pantri/include/auto.php";
			} else {
				var serverPage = "pantri/include/auto.php" + "?sstring=" + thevalue.substr (0, (thevalue.length -1));
			}
		} else {
			var serverPage = "pantri/include/auto.php" + "?sstring=" + thevalue + String.fromCharCode (theextrachar);
		}
	...
	//////////////////////////////////////////////
	function setvalue_pantri (thevalue,kode,hrg){
		acObject = document.getElementById("autocomplete_pantri");
		...
		document.getElementById("hrg_sat").value = hrg;
		document.getElementById("nm_barang").focus();
...
function autocomplete_resep (thevalue, e){
	...
	function setvalueobat (thevalue){
		...
		document.getElementById("kode_obat").value = obat1[0];
		document.getElementById("obat").value = obat1[1];

...
<form name="formsavelab" id="formsavelab" method="post" action="rajal/saveorderlab.php">
...
?>
 ...
 <br />
 <table>
 <tr><td><input type="submit" class="text" value="S i m p a n" submit="submitform (document.getElementById('formsavelab'),'rajal/saveorderlab.php','validlab',validatetask);return false;" />
 </td></tr>
 </table>

...
?>
<form name="rontagen" id="rontagen" action="rajal/valid_rontgen.php" method="post">
<table width="60%" >
<tr><td valign="top">
...
<input type="submit" name="saved" class="text" value=" Simpan " onsubmit="newsubmitform (document.getElementById('rontagen'),'rajal/valid_rontgen.php','val_rontagen',validatetask); return false;"/>
</td>
</tr>
</table>
</div>

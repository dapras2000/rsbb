...
$sql = "INSERT INTO t_usg (idxdaftar, tanggal_periksa, hasil_periksa, kd_dokter, JNS_ELEKTROMEDIK, KDUNIT)
		VALUES('".$iddaftar."',now(),'".$resume."','".$dokter."', 'USG', 2)";
mysql_query($sql);
...
mysql_query("INSERT INTO t_billrajal (KODETARIF, NOMR, KDPOLY, TANGGAL, NIP, QTY, IDXDAFTAR, NOBILL,
  									TARIFRS, KETERANGAN)
					 VALUES ('01050202', '".$nomr."', '2', curdate(), '".$_SESSION['NIP']."', 1, '".$iddaftar."', '$maxnobyr', '$tarifrs', '')");
...
alert("Update Sukess");
window.location="../../index.php?link=51&nomr=<?=$nomr?>&menu=7&idx=<?=$iddaftar?>";
</script>
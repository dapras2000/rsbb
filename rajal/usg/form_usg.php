...
$sql_usg = "SELECT idxdaftar, tanggal_periksa, hasil_periksa, kd_dokter
			FROM t_usg 
			WHERE JNS_ELEKTROMEDIK = 'USG' AND idxdaftar = ".$_GET['idx'];
...
<div align="center">
    ...
    <div id="frame_title">
      <h3>FORM USG</h3></div>
<form id="formperiksaradiologi" name="formperiksaradiologi" method="post" action="rajal/usg/save_usg.php">
  <table width="700" border="0" cellspacing="0" cellpadding="2" align="center" class="tb">
    ...
    <tr valign="top">
      <td>Dokter</td>
      <td><? 
	  	$sqlx = "select * from m_dokter where kdpoly = 2";

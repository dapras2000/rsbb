<?php
	...
	$sql_x = '' . 'select a.code_list,b.description,a.pasien,a.pbi,a.jamkesda,a.swasta,a.umum from rl36 a left join m_rl36 b on b.code_list=a.code_list where a.code_list= \'' . $kode . '\' and a.smt=\'' . $bln . '\' and a.tahun=\'' . $tahun . '\'';	
...
';
	...
	function hitung2(){
		...
		document.getElementById(\'total\').value=eval(document.getElementById';
	echo '(\'pasien\').value) + eval(document.getElementById(\'jamkesda\').value) + eval(document.getElementById(\'swasta\').value) +  eval(document.getElementById(\'umum\').value) +  eval(document.getElementById(\'pbi\').value);
...
function cancel(){
	window.location = "'._BASE_.'/index.php?link=rl36";
}
...
<div id="frame">
    <div id="frame_title"><h3>Laporan RL 3.6</h3></div>
...
<tr><th rowspan=2 style=\'background:#39b54a;border:1px solid grey;\'>Jenis Pelayanan</th><th rowspan=2 style=\'background:#39b54a;border:1px solid grey;\'>Jumlah Pasien</th><th rowspan=2  style=\'background:#39b54a;border:1px solid grey;\'>BPJS</th>
<th rowspan=2 style=\'background:#39b54a;border:1px solid grey;\'>Jamkesda</th><th rowspan=2 style=\'background:#39b54a;border:1px';
	echo ' solid grey;\'>Lain Lain</th>
...
<option value="';
	...
	echo '</option>
';
	$sql = 'select code_list,description from m_rl36 order by code_list';
...
';
	...
	echo '</select></td>
<td style=\'background:#fffff;border:1px solid grey;font-size:12px;\'><input type=\'text\' id=\'pasien\' name=\'pasien\' size=3 onchange=\'hitung2()\' ';
...
<td style=\'background:#fffff;border:1px solid grey;font-size:12px;\'><input type=\'text\' id=\'umum\' name=\'umum\' size=3 onchange=\'hitung2()\' ';
	...
	echo '><td style=\'background:#fffff;border:1px solid grey;font-size:12px;\'><input type=\'text\' id=\'total\' name=\'total\' size=3 ';

...
$url = "http://192.168.111.187/inacbg/olahcbg_as.php";
...
print '<a href=?link=133b&nomr='.$nilai2.'&poli=&nama=&KDCARABAYAR=&tgl_kunjungan=&tgl_kunjungan2=>'.$data['status_msg'].'<a>';
}
else{

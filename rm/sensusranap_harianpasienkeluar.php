...
<div align="center">
	...
	<form name="formsearch" method="get" >
            ...
            <tr>
            	<td>&nbsp;</td>
            	<td><input type="submit" value="Cari" class="text"/><input type="hidden" name="link" value="122harianpasienkeluar" /></td>
            </tr>
            </table>
        ...
        <?php
		$sql3	= mysql_query('SELECT a.nomr,c.nama, c.jeniskelamin,ROUND(DATEDIFF(a.TGLMASUK,c.TGLLAHIR) / 365)  AS umur,
...
<p><form action="rm/sensusranap_harianpasienkeluar_xls.php" method="get">

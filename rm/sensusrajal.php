...
<div align="center">
 ...
 <table width="248" border="0" cellspacing="0" class="tb">
  ...
  <tr>
    ...
    <input type="hidden" name="link" value="133" /></td>
  </tr>
</table>
  ...
  <tr>
	...
	<td align="right"><input type="submit" value="Simpan" class="text" /></td> 
        ...
        <table width="100%" border="0" cellspacing="0" cellspading="0" class="tb">
          ...
          <?
	$sql = "SELECT a.tanggal, p.nama AS poly, a.idxdaftar, 
a.nomr,b.nama,b.TGLLAHIR, b.jeniskelamin,a.tanggal, b.kota, 
a.diagnosa,a.terapi, 
...
a.icd_code, a.icd_code2, e.jenis_penyakit, f.namadokter, k.NAMA AS RUJUKAN, c.KETRUJUK,a.NIP
...
inner join m_dokter f on (c.kddokter=f.kddokter)".$search;
 ...
 <?php 
   ...
   ?>         
            ...
            <td align="center"><? echo $data['icd_code2'];?> </td>            
            <td><? echo $data['jenis_penyakit'];?> </td>            
            <td><a href="?link=133&page=<?=$_GET['page']?>&opt=1&idx=<?=$data['idxdaftar']?>&tgl_kunjungan=<?=$tgl_kunjungan?>&tgl_kunjungan2=<?=$tgl_kunjungan2?>&poli=<?=$poli?>" class="text" >ICD</a></td>
          </tr>
	 <?	} 

<?php
	...
	$sql_x = '' . 'select a.code_list,b.nama,a.pbi,a.jamkesda,a.swasta,a.umum from rl332 a left join m_poly b on b.kode=a.code_list where a.code_list= \'' . $kode . '\' and a.smt=\'' . $bln . '\' and a.tahun=\'' . $tahun . '\'';
	...
	$jumlah = $row_x[pbi];
	$total = $jumlah + $row_x[jamkesda] + $row_x[swasta] + $row_x[umum];
	echo '
<html>
<head>
...
';
	...
	echo 'Id(\'pbi\').value) + eval(document.getElementById(\'jamkesda\').value) + eval(document.getElementById(\'swasta\').value) +  eval(document.getElementById(\'umum\').value);
...
document.getElementById(\'j_jkn\').value=0;
...
function cancel(){
	window.location = "'._BASE_.'/index.php?link=rl332";
}
...
<div id="frame">
    <div id="frame_title"><h3>Laporan RL 3.3.2</h3></div>
...
<tr><th rowspan=2 style=\'background:#39b54a;border:1px solid grey;\'>Jenis Pelayanan</th><th rowspan=2  style=\'background:#39b54a;border:1px solid grey;\'>BPJS</th>
<th rowspan=2 style=\'background:#39b54a;border:1px solid grey;\'>Jamkesda</th><th rowspan=2 style=\'background:#39b54a;border:1px solid grey;\'>Lain Lain</th>
<th rowspan=2 style=\'background:#39b54a;border:';
	echo '1px solid grey;\'>Umum</th>
...
';
	...
	echo '</select></td>
<td style=\'background:#fffff;border:1px solid grey;font-size:10px;\'><input type=\'text\' id=\'pbi\' name=\'pbi\' size=3 onchange=\'hitung2()\' ';
...
<td style=\'background:#fffff;border:1px solid grey;font-size:10px;\'><input type=\'text\' id=\'jamkesda\' name=\'jamkesda\' size=3 onchange=\'hitung2()\' ';
	...
	echo '></td>
<td style=\'background:#fffff;border:1px solid grey;font-size:10px;\'><input type=\'text\' id=\'swasta\' name=\'swasta\' size=3 onchange=\'hitung2()\'  ';
...
<td style=\'background:#fffff;border:1px solid grey;font-size:10px;\'><input type=\'text\' id=\'umum\' name=\'umum\' size=3 onchange=\'hitung2()\' ';
	...
	echo '><td style=\'background:#fffff;border:1px solid grey;font-size:10px;\'><input type=\'text\' id=\'total\' name=\'total\' size=3 ';

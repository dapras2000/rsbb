<?php
	...
	$sql_x = '' . 'select a.code_list,b.description,a.pasien,a.pbi,a.jamkesda,a.swasta,a.umum from rl37 a left join m_rl37 b on b.code_list=a.code_list where a.code_list= \'' . $kode . '\' and a.smt=\'' . $bln . '\' and a.tahun=\'' . $tahun . '\'';
	$hasil_x = mysql_query( $sql_x );	
	$row_x = mysql_fetch_array( $hasil_x );
	$jumlah = $row_x[pbi];
	$total = $jumlah + $row_x[jamkesda] + $row_x[swasta] + $row_x[umum] + $row_x[pasien];
	echo '
<html>
<head>
...
';
	...
	function hitung2(){
		...
		document.getElementById(\'total\').style.backgroundColor=\'#ccccc\';
		document.getElementById(\'total\').value=eval(document.getElementBy';
	echo 'Id(\'pasien\').value) + eval(document.getElementById(\'jamkesda\').value) + eval(document.getElementById(\'swasta\').value) +  eval(document.getElementById(\'umum\').value) +  eval(document.getElementById(\'pbi\').value);
...
echo '<script type="text/javascript">
   function cek(){
document.getElementById(\'pasien\').focus();  
...
function cancel(){
	window.location = "'._BASE_.'/index.php?link=rl37";
}
...
<tr><th rowspan=2 style=\'background:#39b54a;border:1px solid grey;\'>Jenis Pelayanan</th><th rowspan=2 style=\'background:#39b54a;border:1px solid grey;\'>Jumlah Pemeriksaan</th><th rowspan=2  style=\'background:#39b54a;border:1px solid grey;\'>JKN</th>
<th rowspan=2 style=\'background:#39b54a;border:1px solid grey;\'>Jamkesda</th><th rowspan=2 style=\'background:#39b54a;borde';
	echo 'r:1px solid grey;\'>Jaminan Swasta</th>
<th rowspan=2 style=\'background:#39b54a;border:1px solid grey;\'>Umum</th>
...
<option value="';
	...
	echo '</option>
';
	$sql = 'select code_list,description from m_rl37 where code_list !=\'\' order by code_list';
...
';
	...
	echo '</select></td>
<td style=\'background:#fffff;border:1px solid grey;font-size:12px;\'><input type=\'text\' id=\'pasien\' name=\'pasien\' size=3 onchange=\'hitung(2)\' ';

	if (1 <= $row_x[pasien]) {
		echo '' . 'value=' . $row_x['pasien'];
	} 
else {
		echo 'value=0';
	}
	...
	echo '></td>
<td style=\'background:#fffff;border:1px solid grey;font-size:12px;\'><input type=\'text\' id=\'pbi\' name=\'pbi\' size=3 onchange=\'hitung2()\' ';
	...
	echo '></td>
<td style=\'background:#fffff;border:1px solid grey;font-size:12px;\'><input type=\'text\' id=\'jamkesda\' name=\'jamkesda\' size=3 onchange=\'hitung2()\' ';
	...
	echo '></td>
<td style=\'background:#fffff;border:1px solid grey;font-size:12px;\'><input type=\'text\' id=\'swasta\' name=\'swasta\' size=3 onchange=\'hitung2()\'  ';
	...
	echo '></td>
<td style=\'background:#fffff;border:1px solid grey;font-size:12px;\'><input type=\'text\' id=\'umum\' name=\'umum\' size=3 onchange=\'hitung2()\' ';

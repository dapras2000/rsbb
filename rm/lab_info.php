...
$sql = "SELECT b.`nama_tindakan`, a.`HASIL_PERIKSA`, a.`nilai_normal`, a.`UNIT`, a.nolab 
FROM t_orderlab a
JOIN m_tarif2012 b ON a.`KODE` = b.`kode_tindakan` where a.idxdaftar = '".$_REQUEST['idx']."'";
$rowxx= mysql_query($sql)or die(mysql_error());

$myquery = "SELECT a.`NOLAB`,a.`TANGGAL`,b.`NAMA`, b.`JENISKELAMIN`, b.`TGLLAHIR`, c.`NAMADOKTER`, d.`nama` AS POLY, a.`NOMR`, a.IDXDAFTAR, a.NOLAB
FROM t_orderlab a

...
$sql = "SELECT 
		  ...
		  m_barang.satuan,
		  DATE_FORMAT(t_penerimaan_barang.tglterima, '%d -%m -%Y') as tglterima
		FROM
		  m_barang
		  ...
		  INNER JOIN t_penerimaan_barang ON (m_barang.kode_barang = t_penerimaan_barang.kodebarang)
...
<div align="center">
    <div id="frame">
    <div id="frame_title"><h3>LIST PENERIMAAN BARANG</h3></div>
    <div align="right" style="margin:5px;">
    <form name="formsearch" method="get" >
     <table class="tb">
       <tr>
          <td align="right">Tanggal Pesan&nbsp;<input type="text" name="tgl_pesan" id="tgl_pesan" readonly="readonly" class="text" 
              ...
              <input type="hidden" name="link" value="f05" />
    ...
    $pager = new PS_Pagination($connect, $sql, 15, 5, "tgl_pesan=".$tgl_pesan,"index.php?link=f05&");

...
<div align="center">
    <div id="frame" style="width:100%;">
        <div id="frame_title"><h3>PENGELUARAN BARANG</h3></div>
        <div align="left" style="margin:5px;">

        <form name="terimabarang" id="terimabarang" action="orderbarang/addbarangpengeluaran.php" method="post" >
            <fieldset class="fieldset">
                <table class="tb" align="left">
                    <tr>
                        <td>No RM</td>
                        <td><input type="text" name="nomr" value="<?=$_GET['nomr']?>" readonly="readonly" class="text" style="width:50px"/></td>
                    </tr>
                    <tr>
                        <td colspan="2" ><input type="checkbox" name="f_pasien" <? if(!empty($_GET['idx'])) echo "checked='checked'"; ?> value="1" />&nbsp;Untuk Pasien</td>
                    </tr>
                    <tr>
                        <td>Tgl Keluar</td>
                        <?php $tgl =  date("Y-m-d");?>
                    ...
                    <tr>
                        ...
                        <td><input type="submit" class="text" value="A d d" onclick="submitform (document.getElementById('terimabarang'),'orderbarang/addbarangpengeluaran.php','validbarang',validatetask);
        ...
        <div id="validbarang" align="left"></div>
    </div>
</div>
</div>

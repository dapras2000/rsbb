...
<fieldset class="fieldset">
    ...
    <table class="tb">
        ...
        <tr>
            ...
            <td><?=$data['RUANG']?></td>
            <td><a href="#" style="text" onclick="javascript: MyAjaxRequest('validbarang','orderbarang/addbarangpengeluaran.php?optbarang=<?=$data['IDX']?>'); return false;" >Hapus</a></td>
        </tr>
                <?php $i++;
    } ?>
    </table>

    <form name="savebarang" id="savebarang" action="orderbarang/savebarangpengeluaran.php" method="post" >
        <input class="text" type="submit" value="S i m p a n" onclick="submitform (document.getElementById('savebarang'),'orderbarang/savebarangpengeluaran.php','validbarang',validatetask); return false;"/>
    </form>
</fieldset>   
    <? } ?>

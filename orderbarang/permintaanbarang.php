    ...
    <div id="frame" style="width:100%;">
        ...
        <div align="left" style="margin:5px;">
            <fieldset class="fieldset">
                <form name="addbarang" id="addbarang" method="post" action="orderbarang/addbarang.php" >
                    <table align="left" class="tb">
                        <tr>
                            ...
                            <td colspan="2" width="225">Ke &nbsp;
                                <input type="radio" class="text" name="r_barang" id="gudang" value="G"
                                       onclick="javascript: MyAjaxRequest('grpbarangx','orderbarang/changegroup.php?gudang=gudang');
                                           MyAjaxRequest('ruang','orderbarang/changegroup.php?ruang=x'); MyAjaxRequest('ruang_h','orderbarang/changegroup.php?ruang_h=x');
                                           document.getElementById('gudang').checked();
                                           return false;" />
                                Gudang Farmasi
                                <input type="radio" class="text" name="r_barang" id="logistik"  value="L" onclick="javascript: MyAjaxRequest('grpbarangx','orderbarang/changegroup.php?logistik=logistik');
                                    MyAjaxRequest('ruang','orderbarang/changegroup.php?ruang=x'); MyAjaxRequest('ruang_h','orderbarang/changegroup.php?ruang_h=x');
                                    document.getElementById('logistik').checked();
                                    return false;"/>
                                Gudang Umum
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>No Batch</td>
                            <td><input type="text" class="text" name="no_batch" id="no_batch" readonly="readonly"/></td>
                        </tr>
                        <tr>
                            <td>Tgl Kadaluarsa</td>
                            <td><input type="text" class="text" name="tgl_kadaluarsa" id="tgl_kadaluarsa" readonly="readonly"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" ><input type="submit" class="text" value="A d d" onclick="newsubmitform (document.getElementById('addbarang'),'orderbarang/addbarang.php','validbarang',validatetask); document.getElementById('nm_barang').value = ''; document.getElementById('kd_barang').value = '';  document.getElementById('jml_permintaan').value = ''; document.getElementById('no_batch').value = '';document.getElementById('tgl_kadaluarsa').value = ''; return false;" /></td>
                        </tr>
                    </table>

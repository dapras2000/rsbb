...
#include("../ps_paginationfarmasi_new.php");
...
if($tgl_pesan !=""){
	$search = " AND t_pengembalian_barang.tglkeluar = '".$tgl_pesan."' ";
}else{
	$search = "";
}
...
$sql = "SELECT 
		  ...
		  m_barang.satuan,
		  DATE_FORMAT(t_pengembalian_barang.tglkeluar, '%d -%m -%Y') as tglkeluar,
		  t_pengembalian_barang.NOMR
		FROM
		  m_barang
		  ...
		  INNER JOIN t_pengembalian_barang ON (m_barang.kode_barang = t_pengembalian_barang.kodebarang)
		WHERE t_pengembalian_barang.KDUNIT ='".$_SESSION['KDUNIT']."' ".$search;
...
<div align="center">
    ...
    <form name="formsearch" method="get" >
     <table class="tb">
       <tr>
           <td align="right">Tanggal Kembali&nbsp;<input type="text" name="tgl_pesan" id="tgl_pesan" readonly="readonly" class="text" style="width:100px;"
              ...
              <input type="hidden" name="link" value="f22" />
    ...
    $pager = new PS_Pagination($connect, $sql, $sqlcounter, 15, 5, "tgl_pesan=".$tgl_pesan,"index.php?link=f22&");

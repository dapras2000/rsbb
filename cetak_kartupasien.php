...
<table border="0" cellpadding="0" cellspacing="0" width="400px">
	...
	<tr><td>
			<table style="font-size: 14px; padding-left: 10px;" width="100%">
				...
				</td  style="font-size: 14px;"><td>:</td><td style="font-size: 14px;"><? echo $data['JENISKELAMIN']; ?></td</tr>
				<tr  style="font-size: 14px;"><td>Alamat
				</td><td>:</td><td style="font-size: 14px;"><? echo $data['ALAMAT']; ?></td></tr>
				<tr><td>
				</td><td></td><td>
				<img  alt="<? echo $data['NOMR']; ?>" src="include/barcode.php?codetype=Code39&size=20&text=<? echo $data['NOMR']; ?>&print=true" /></td></tr>

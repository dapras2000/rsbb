...
<div align="center" style="width:590px; float:left;">
    <div id="frame" style="width: 100%;">
        ...
        <input type="text" 	 name="idxdaftar" id="idxdaftar" value="<?php echo $_GET['idx']; ?> " />
    	...
    	<br clear="all" />
    	<input type="button" name="simpan" value="S I M P A N" id="simpan1" class="text" />
    	</form>
		</div>
	</div>
	<br clear="all" />

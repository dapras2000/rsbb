    ...
    echo $nama;
                    ...
                    <tr>
                        ...
                        <td><input type="submit" value="Cari" class="text"/>
                            <input type="hidden" name="link" value="list_pasien_rajal_lab" /></td>
                    </tr>
                </table>
...
JOIN m_carabayar e ON e.KODE = a.KDCARABAYAR
                    ...
                    <?php
                        ...
                        <td>
						<?php
							echo '<a href="'._BASE_.'index.php?link=62formorderlab_rajal&nomr='.$data['NOMR'].'&idx='.$data['IDXDAFTAR'].'"><input type="button" value="TAMBAH PEMERIKSAAN" class="text"/></a>';
						?>
                        </td>
                    </tr>
                        <?	$i++;

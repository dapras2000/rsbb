...
mysql_query('insert into tmp_cartorderlab set IP ="'.getRealIpAddr().'", KET = "APS", UNIT = "'.$_SESSION['KDUNIT'].'", NOMR = "'.$nomr.'", IDXDAFTAR = "'.$idxdaftar.'", TGLDAFTAR = "'.date('Y-m-d').'", NIP = "'.$_SESSION['NIP'].'", APS = "1"');

header("Location:../index.php?link=6&idx=".$idxdaftar);
exit;
?>

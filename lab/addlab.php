...
$myquery = "select a.NOMR,a.KDPOLY,a.KDDOKTER,a.TGLREG,b.NAMA,b.ALAMAT,b.JENISKELAMIN,b.TGLLAHIR,c.NAMA as CARABAYAR, a.IDXDAFTAR, d.NAMA as POLY, e.NAMADOKTER
			  ...
			  where a.NOMR=b.NOMR AND a.KDCARABAYAR=c.KODE AND d.KODE=a.KDPOLY and a.KDDOKTER=e.KDDOKTER
			        and a.IDXDAFTAR='".$_GET["idxDaftar"]."'";
    ...
    <form name="formlab" id="formlab" method="post" action="lab/validorderlab.php">
       <table width="100%"><tr>
...
<?php  if(count($row2_tab_1 > 0)){
            ...
            <tr>
             ...
             onchange="newsubmitform (document.getElementById('formlab'),'lab/validorderlab.php','validlab',validatetask); return false;"/>&nbsp;<?php echo $data2_tab_1['nama_jasa']?></td>
            </tr>
<? } }?>
<?php } ?>     
   </table></td>
...
<?php  if(count($row2_tab_2 > 0)){
            ...
            <tr>
             ...
             onchange="newsubmitform (document.getElementById('formlab'),'lab/validorderlab.php','validlab',validatetask); return false;"/>&nbsp;<?php echo $data2_tab_2['nama_jasa']?></td>
            </tr>
<? } }?>
<?php } ?>     
   </table>
...
<?php  if(count($row2_tab_3 > 0)){
            ...
            <tr>
             ...
             onchange="newsubmitform (document.getElementById('formlab'),'lab/validorderlab.php','validlab',validatetask); return false;"/>&nbsp;<?php echo $data2_tab_3['nama_jasa']?></td>
            </tr>
<? } }?>
<?php } ?>     
   </table>
...
<?php  if(count($row2_tab_4 > 0)){
            ...
            <tr>
             ...
             onchange="newsubmitform (document.getElementById('formlab'),'lab/validorderlab.php','validlab',validatetask); return false;"/>&nbsp;<?php echo $data2_tab_4['nama_jasa']?></td>
            </tr>
<? } }?>
<?php } ?>     
   </table>

...
<div align="center">
    ...
    <div id="frame_title"><h3>LIST HASIL LAB</h3></div>
  ...
  <tr>
    ...
    <input type="hidden" name="link" value="61" /></td>
  </tr>
</table>
...
WHERE a.`STATUS` = 1 '.$search.' GROUP BY a.`NOLAB`';
	 $NO=0;
	$pager = new PS_Pagination($connect, $sql, 15, 5, "tgl_kunjungan=".$tgl_kunjungan."&tgl_kunjungan2=".$tgl_kunjungan2."&nama=".$nama."&norm=".$norm,"index.php?link=61&");
    ...
    ($hal*15)+$NO;?></td>
            ...
            <td><a href="index.php?link=63&amp;nomr=<?php echo $data['NOMR']?>&idx=<?php echo $data['IDXDAFTAR']?>&nolab=<?php echo $data['NOLAB']?>" ><input type="button" value="LIHAT" class="text"/></a> | <a href="index.php?link=lab1&amp;nomr=<?php echo $data['NOMR']?>&idx=<?php echo $data['IDXDAFTAR']?>&option=2&nolab=<?php echo $data['NOLAB']?>" ><input type="button" value="UBAH" class="text"/></a></td>
          </tr>
	 <?	} 

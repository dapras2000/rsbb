    ...
    $(document).ready(function() {
        ...
        $("#formDecubitus").validate({
            ...
            submitHandler: function(form) {
                ...
                $.post('kep/decubitus_saved.php', $("#formDecubitus").serialize(), function(data) {
                    alert('data berhasil disimpan');
                    $('#formDecubitus').each(function() {
                        this.reset();
                    });
                    $('#table_decubitus').load('kep/decubitus_table.php');
//                    $('#results').html(data);
                });
            }
        });
...
//            return true;
            $.ajax({
                url: 'kep/decubitus_table.php?id=' + id,
                type: 'DELETE',
...
<div id="result" ></div>
<fieldset><legend>Input Data Decubitus</legend>
    <form id="formDecubitus" method="post" action="">
        <table width="100%" border="0" cellpadding="4" cellspacing="2">

            <tr>
                <td width="200"><label for="tgl" id="tgl_label">TGL</label></td>
                <td><input type="text" name="tgl" class="required" id="tgl"> <b>(format:dd-mm-YYYY)</b></td>
            </tr>

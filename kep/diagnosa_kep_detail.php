...
<div align="center">
  <div id="frame">
  <div id="frame_title"><h3 align="left">Detail Diagnosa Keperawatan</h3></div>
	<div id="all">	
    ...
    <fieldset class="fieldset"><legend>Diagnosa Keperawatan</legend>
      <table width="50%" border="0" cellpadding="3" cellspacing="0" align="left">
        ...
        <tr>
          <td colspan="5" align="right"><a href="?link=diagnosa_kep&NOMR=<?=$_GET['NOMR'];?>&nama=<?php echo $_GET['nama']?>&idadmission=<?php echo $_GET['idadmission']?>"><input type="button" value="  K e m b a l i  " class="text" /></a>&nbsp;&nbsp;&nbsp;<input type="submit" name="daftar" class="text" value="  S i m p a n  "/></td>
        </tr>
      </table>
	  </form>
        ...
        <div align="right" style="margin:5px; margin-right:10px;">
			...
			<form method="get" action="<? $_SERVER['PHP_SELF']; ?>" name="formku" id="formku" onSubmit="return validasi()" >
                <table width="95%" style="margin:10px;" border="0" class="tb" cellspacing="1" cellspading="1" title="List Semua Data Pasien.">
				   ...
				   <input type="text" name="kegiatan" id="kegiatan" width="200" maxlength="200"><input type="submit" value="search"></td></tr>
				    <tr align="center">
                        <th width="2%">No</th>

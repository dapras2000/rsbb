...
<div align="center">
  <div id="frame">
  <div id="frame_title"><h3 align="left">PENGAJUAN KELUAR</h3></div>
	<div id="all">
    <form name="myform" id="myform" action="./kep/edit_keluar.php" method="post">
	<div id="list_data"></div>
    <fieldset class="fieldset"><legend>Pengajuan Keluar</legend>
      <table width="100%" border="0" cellpadding="3" cellspacing="0">
		...
		<tr>
          ...
          <td colspan="3"><input class="text" value="<?=$data['ALASAN']?>" type="text" name="ALASAN" id="ALASAN" size="25" ></td>
          <td colspan="2" />
        </tr>
		<tr>
          <td>Tanggal Keluar</td>
          <td colspan="3">
            <input type="text" class="text required" value="<?=$data['TGLKELUAR']?>" name="TGLLAHIR" size="20" id="TGLLAHIR" onblur="calage(this.value,'umur');"/>

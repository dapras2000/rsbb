...
jQuery(document).ready(function(){
	...
	jQuery('.print').click(function(){
		var idxdaftar	= jQuery(this).attr('rel');
		var idxbayar	= jQuery(this).attr('svn');
		jQuery.get('<?php echo _BASE_; ?>print_pembayaran_gizi.php?idxb='+idxbayar+'&nomr=<?php echo $_REQUEST['nomr']; ?>',function(data){
...
<div align="center">
<div id="frame">
	<div id="frame_title"><h3>Cart Bayar Konsultasi Gizi Rawat Jalan</h3></div>
...
<?php
		...
		$q_pasien	= "select a.NOMR, b.NAMA, b.ALAMAT, b.JENISKELAMIN, b.TGLLAHIR, c.NAMA as CARABAYAR, a.KDCARABAYAR, a.IDXDAFTAR, a.KDPOLY, d.nama as nama_poly,a.KDDOKTER 
		from t_pendaftaran a, m_pasien b, m_carabayar c, m_poly d where a.NOMR = b.NOMR and a.KDCARABAYAR = c.KODE and a.KDPOLY = d.kode and a.NOMR = '".$_REQUEST['nomr']."' and a.IDXDAFTAR = '".$_REQUEST['idxdaftar']."'";
...
WHERE a.NOMR = "'.$_REQUEST['nomr'].'" AND b.KODETARIF like "01.01.18%" AND a.STATUS !="BATAL" AND b.IDXDAFTAR = "'.$_REQUEST['idxdaftar'].'"
GROUP BY 
a.NOMR, b.NOBILL,
a.TGLBAYAR , b.IDXDAFTAR';
